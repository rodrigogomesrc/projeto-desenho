...
Com tudo configurado, temos que realizar a documentação do código através de comentário, como está na documentação 
do doxygen presente no link abaixo:
...
caso dê um erro de comando não encontrado, teremos que fazer as instalações conforme o link abaixo, antes de tentar novamente:
